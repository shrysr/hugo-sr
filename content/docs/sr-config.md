...
lastmod = 2019-07-10T13:55:46-06:00
tags = ["Emacs"]
categories = ["Emacs"]
draft = false
...
#### <span class="org-todo todo TODO">TODO</span> Using this configuration {#using-this-configuration}
...
#### <span class="org-todo todo TODO">TODO</span> Overall Tasks and Areas of Improvement <code>[0/5]</code> {#overall-tasks-and-areas-of-improvement}
...
## Emacs General config {#emacs-general-config}
...
## Easier selection {#easier-selection}


### <span class="org-todo todo TODO">TODO</span> Expand region {#expand-region}
...
## <span class="org-todo todo TODO">TODO</span> ESS configuration <code>[0/0]</code> {#ess-configuration}
...
### ESS Buffer display Config {#ess-buffer-display-config}
...
#### Refile target level for search {#refile-target-level-for-search}
...
#### <span class="org-todo todo TODO">TODO</span> General refile settings {#general-refile-settings}
...
#### [Also refer Refiling hydra](#refiling) {#also-refer-refiling-hydra--refiling}
...
#### Include gpg files in agenda generation {#include-gpg-files-in-agenda-generation}
...
#### Expanding search locations {#expanding-search-locations}
...
#### Enable sticky agenda {#enable-sticky-agenda}
...
#### <span class="org-todo todo TEST">TEST</span> Closing org-capture frame on abort {#closing-org-capture-frame-on-abort}
...
#### <span class="org-todo todo TEST">TEST</span> Optimise CREATED and PLANNED property tags {#optimise-created-and-planned-property-tags}
...
#### Enabling adding tags in the capture window {#enabling-adding-tags-in-the-capture-window}
...
#### Loading language base {#loading-language-base}
...
#### Clojure and cider {#clojure-and-cider}
...
#### Continuous clocking + punch in/out approach {#continuous-clocking-plus-punch-in-out-approach}
...
#### <span class="org-todo todo TEST">TEST</span> org-mru-clock {#org-mru-clock}
...
#### Do not log or consider 0 Clocks {#do-not-log-or-consider-0-clocks}
...
#### set idle timer for clocked task {#set-idle-timer-for-clocked-task}
...
#### Show clocked task history and enable re-clocking {#show-clocked-task-history-and-enable-re-clocking}
...
#### <span class="org-todo done STABLE">STABLE</span> Basic setup along with org-id {#basic-setup-along-with-org-id}
...
#### setting org-capture template for Journal {#setting-org-capture-template-for-journal}
...
#### <span class="org-todo todo TODO">TODO</span> Figure out easy encryption approach for org journal {#figure-out-easy-encryption-approach-for-org-journal}
...
## <span class="org-todo todo TEST">TEST</span> Projectile behavior {#projectile-behavior}
...
### <span class="org-todo todo TEST">TEST</span> Switching to aspell on the mac {#switching-to-aspell-on-the-mac}
...
#### Scimax config directory {#scimax-config-directory}
...
#### Scimax - magit and windows {#scimax-magit-and-windows}
...
#### Org files - magit and windows {#org-files-magit-and-windows}
...
#### Project directory - magit and windows {#project-directory-magit-and-windows}
...
#### <span class="org-todo todo TODO">TODO</span> Project: Switch and windows {#project-switch-and-windows}
...
### Elfeed-org and elfeed-goodies setup <code>[/]</code> {#elfeed-org-and-elfeed-goodies-setup}
...
#### <span class="org-todo todo TODO">TODO</span> Defining content directory {#defining-content-directory}
...
#### Ensuring properties exist and creating if they dont exist {#ensuring-properties-exist-and-creating-if-they-dont-exist}
...
#### Hugo function calling the above {#hugo-function-calling-the-above}
...
### <span class="org-todo todo NEXT">NEXT</span> setup virtual environment approach {#setup-virtual-environment-approach}


### <span class="org-todo todo NEXT">NEXT</span> setup conda, especially for auto complete {#setup-conda-especially-for-auto-complete}
...
### <span class="org-todo todo TEST">TEST</span> Use-package based template for customising zenburn {#use-package-based-template-for-customising-zenburn}
