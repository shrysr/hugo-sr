+++
title = "CFD Post processing macros"
...
- [How it helped](#how-it-helped)
- [Python script](#python-script)

</div>
<!--endtoc-->

> This is one of my earliest projects and among the first few scripts that I wrote, to automate the boring stuff. While it may look quite horrible today, it undoubtedly saved a very large number of working hours at the time it was written. As you can see, version control was a thing I knew nothing about at that itme. This post id left here for posterity. <span class="timestamp-wrapper"><span class="timestamp">[2025-08-04 Mon]</span></span>
...
-   While these operations could be done directly in python, it is easier and simpler to control ANSYS CFD post using a BASH script. Therefore the python program creates a BASH script.
