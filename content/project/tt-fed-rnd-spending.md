...
lastmod = 2019-11-01T18:29:34-06:00
...
For a quick look at the outliers, we can use a boxplot, using DatExplorer's functions.

```R
variance_climate_spend <- plot_boxplot(climate_spend_raw, by = "year")
```

{{< figure src="/img/variance-spend.png" caption="Figure 1: It can be seen above that there are not many outliers. Subsequent visualisations will show that NASA is most significant outlier." >}}
...
{{< figure src="/ox-hugo/fed-rnd-spending-1.png" >}}
...
{{< figure src="/ox-hugo/fed-rnd-spending-2.png" >}}
