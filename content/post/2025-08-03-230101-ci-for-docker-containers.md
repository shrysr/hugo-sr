+++
title = "Set up Continuous Integration (CI) for docker containers"
author = ["Shreyas Ragavan"]
date = 2020-01-21T22:30:00-08:00
tags = ["docker", "ContinuousIntegration", "DataScienceJournal"]
draft = false
profile = false
toc = true
+++
...
1.  [-] Complete reading the [Github documentation on github actions](https://help.github.com/en/actions).
